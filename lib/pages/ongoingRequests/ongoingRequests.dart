...
class OngoingRequests extends StatefulWidget {
  ...
  const OngoingRequests({Key? key, this.currentPage = 'OngoingRequests'})
      : super(key: key);

  @override
  _OngoingRequestsState createState() => _OngoingRequestsState();
}
...
// Replace these getters with these updated versions
  ...
  Future<void> _fetchAndSetOngoingRequests() async {
    try {
      ...
      final service = OngoingRequestService();
      final data = await service.fetchOngoingAndPausedRequests();
