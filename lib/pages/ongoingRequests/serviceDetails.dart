...
class _ServiceDetailsState extends State<ServiceDetails> {
  ...
  void initState() {
    ...
    // Check if requestData is provided and has an id
    if (widget.requestData != null && widget.requestData!.containsKey('id')) {
      // Extract the id and convert to String if needed
      final requestId = widget.requestData!['id'].toString();

      // Call loadDetails with the extracted ID
                  ...
                  child: SizedBox(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              "Date Requested: February 14, 2025, 10:00AM",
                              style:
